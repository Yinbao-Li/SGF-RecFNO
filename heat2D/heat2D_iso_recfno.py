# -*- coding: utf-8 -*-
"""Train IsoRecFNO (Geometry-aware RecFNO) on 2D heat conduction data."""
import logging
import os
import sys
...
def build_model(args):
    return IsoRecFNO(
        ...
        modes2=args.modes2,
        width=args.width,
        num_iso_levels=len(args.quantiles),
        ...
        if epoch % args.val_interval == 0:
            ...
            with torch.no_grad():
                for inputs, outputs in val_loader:
                    ...
                    last_outputs, last_pre = outputs, aux['field']
            ...
            if epoch % args.plot_freq == 0 and last_outputs is not None:
                plot3x1(
                    ...
                    os.path.join(args.fig_path, f'epoch{epoch}.png'),
                )
